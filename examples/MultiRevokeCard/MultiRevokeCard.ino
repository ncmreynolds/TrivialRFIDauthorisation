...
uint8_t idsToRevoke[] = {0,255}; //Revokes flags at the beginning and end of the data
...
void loop() {
  ...
  {
    Serial.println("*******************************");
    Serial.print("Revoking card for IDs:");
    ...
    if(rfid.revokeCard(idsToRevoke,sizeof(idsToRevoke)) == true)
    {
